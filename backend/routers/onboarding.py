...
ONBOARDING_STEPS = [
    ...
    },
    {
        ...
        "input":    {"id": "workspace_name", "label": "Workspace name", "type": "text", "placeholder": "e.g. My AI Agency, Solo Founder OS, Dev Studio"},
        "action":   None,
        "skip":     False,
    },
    {
...
THEMES = [
    ...
    {"id": "midnight", "name": "Midnight", "bg": "#050810", "accent": "#9d74f5", "preview": "Pure black — OLED friendly"},
...
async def complete_onboarding(req: Request):
    ...
    for k in ["workspace_name", "theme", "accent_color", "default_agent",
              "voice_mode", "tts_voice", "ui_mode", "font_size"]:
        if k in body:
            prefs[k] = body[k]
