...
DEFAULT_SKILLS = [
    ...
    },
    {
        ...
        "inputs":      [
            ...
            {"id": "tone",   "label": "Tone",           "type": "select",   "required": False,
             "options": ["professional","casual","technical","persuasive","friendly"]},
            {"id": "length", "label": "Length",         "type": "select",   "required": False,
    ...
    },
    {
        ...
        "inputs":      [
            ...
            {"id": "goal",     "label": "Goal",            "type": "select", "required": False,
    ...
    },
    {
        ...
        "inputs":      [
            ...
            {"id": "audience", "label": "Audience",        "type": "select",   "required": False,
    ...
    },
    {
        ...
        "inputs":      [
            ...
            {"id": "framework", "label": "Test framework", "type": "select",   "required": False,
