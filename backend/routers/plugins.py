...
BUILTIN_REGISTRY = [
    {
        ...
        "type":        "skill_pack",
        "skills": [
            {"id":"twitter_thread","name":"Twitter Thread","emoji":"🐦","category":"social","agent":"creative",
             "description":"Write a viral Twitter thread on any topic",
             "inputs":[{"id":"topic","label":"Topic","type":"text","required":True},{"id":"length","label":"Length","type":"select","required":False,"options":["5 tweets","8 tweets","12 tweets"]}],
            ...
            {"id":"linkedin_post","name":"LinkedIn Post","emoji":"💼","category":"social","agent":"creative",
            ...
            {"id":"instagram_caption","name":"Instagram Caption","emoji":"📸","category":"social","agent":"creative",
             "description":"Instagram caption with hashtags",
             "inputs":[{"id":"image_desc","label":"Describe the image/content","type":"textarea","required":True},{"id":"tone","label":"Tone","type":"select","required":False,"options":["inspiring","funny","educational","promotional"]}],
            ...
            {"id":"youtube_title","name":"YouTube Optimizer","emoji":"▶️","category":"social","agent":"researcher",
            ...
            {"id":"reddit_post","name":"Reddit Post","emoji":"🤖","category":"social","agent":"creative",
             "description":"Reddit post that fits the community",
             "inputs":[{"id":"topic","label":"Topic","type":"text","required":True},{"id":"subreddit","label":"Target subreddit","type":"text","required":False}],
            ...
            {"id":"product_hunt","name":"Product Hunt Launch","emoji":"🚀","category":"social","agent":"creative",
             "description":"Product Hunt launch copy that gets upvotes",
             "inputs":[{"id":"product","label":"Product name & what it does","type":"textarea","required":True}],
    ...
    },
    {
        ...
        "type":        "skill_pack",
        "skills": [
            {"id":"readme_writer","name":"README Writer","emoji":"📖","category":"development","agent":"builder",
             "description":"Generate a professional README.md",
             "inputs":[{"id":"project","label":"Project name & description","type":"textarea","required":True},{"id":"stack","label":"Tech stack","type":"text","required":False}],
            ...
            {"id":"dockerfile","name":"Dockerfile Generator","emoji":"🐳","category":"development","agent":"builder",
             "description":"Production-ready Dockerfile + compose",
             "inputs":[{"id":"app_desc","label":"App description","type":"textarea","required":True},{"id":"language","label":"Language/Framework","type":"text","required":True}],
            ...
            {"id":"github_actions","name":"GitHub Actions CI","emoji":"⚙️","category":"development","agent":"builder",
             "description":"Complete CI/CD pipeline YAML",
             "inputs":[{"id":"project_type","label":"Project type","type":"text","required":True},{"id":"deploy_target","label":"Deploy target","type":"select","required":False,"options":["Vercel","Railway","Fly.io","AWS","none"]}],
            ...
            {"id":"db_schema","name":"Database Schema Designer","emoji":"🗄️","category":"development","agent":"builder",
             "description":"SQL schema from natural language",
             "inputs":[{"id":"description","label":"Describe your data model","type":"textarea","required":True},{"id":"db_type","label":"Database","type":"select","required":False,"options":["PostgreSQL","MySQL","SQLite","MongoDB"]}],
            ...
            {"id":"api_mock","name":"API Mock Generator","emoji":"🔌","category":"development","agent":"builder",
    ...
    },
    {
        ...
        "type":        "skill_pack",
        "skills": [
            {"id":"business_plan","name":"Business Plan","emoji":"📋","category":"business","agent":"researcher",
            ...
            {"id":"pricing_strategy","name":"Pricing Strategy","emoji":"💰","category":"business","agent":"researcher",
             "description":"SaaS pricing tiers and strategy",
             "inputs":[{"id":"product","label":"Product description","type":"textarea","required":True},{"id":"competitors","label":"Key competitors","type":"text","required":False}],
            ...
            {"id":"investor_email","name":"Investor Cold Email","emoji":"📧","category":"business","agent":"creative",
             "description":"Cold email to VCs/angels that gets replies",
             "inputs":[{"id":"startup","label":"Startup description & traction","type":"textarea","required":True},{"id":"ask","label":"Funding ask","type":"text","required":False}],
            ...
            {"id":"cold_outreach","name":"Cold Outreach Sequence","emoji":"🎯","category":"business","agent":"creative",
             "description":"5-touch outreach sequence for B2B sales",
             "inputs":[{"id":"product","label":"What you're selling","type":"text","required":True},{"id":"icp","label":"Ideal customer profile","type":"text","required":True}],
            ...
            {"id":"user_interview","name":"User Interview Script","emoji":"🎤","category":"business","agent":"researcher",
            ...
            {"id":"retention_analysis","name":"Retention Analysis","emoji":"📊","category":"business","agent":"researcher",
             "description":"Churn analysis and retention improvement plan",
             "inputs":[{"id":"product","label":"Product & current churn symptoms","type":"textarea","required":True}],
    ...
    },
    {
        ...
        "type":        "skill_pack",
        "skills": [
            {"id":"lit_review","name":"Literature Review","emoji":"📚","category":"research","agent":"researcher",
             "description":"Structured literature review on any topic",
             "inputs":[{"id":"topic","label":"Research topic","type":"text","required":True},{"id":"depth","label":"Depth","type":"select","required":False,"options":["overview","detailed","comprehensive"]}],
            ...
            {"id":"trend_analysis","name":"Trend Analysis","emoji":"📈","category":"research","agent":"researcher",
             "description":"Identify and analyse emerging trends",
             "inputs":[{"id":"industry","label":"Industry or topic","type":"text","required":True},{"id":"horizon","label":"Time horizon","type":"select","required":False,"options":["6 months","1 year","3 years","5 years"]}],
            ...
            {"id":"tech_explainer","name":"Technical Explainer","emoji":"💡","category":"research","agent":"brain",
             "description":"Explain any technical concept at multiple levels",
             "inputs":[{"id":"concept","label":"Technical concept","type":"text","required":True},{"id":"audience","label":"Target audience","type":"select","required":False,"options":["5-year-old","beginner","intermediate","expert"]}],
            ...
            {"id":"fact_check","name":"Fact Checker","emoji":"✅","category":"research","agent":"researcher",
             "description":"Verify claims and identify misinformation",
             "inputs":[{"id":"claim","label":"Claim or statement to verify","type":"textarea","required":True}],
            ...
            {"id":"bibliography","name":"Bibliography Generator","emoji":"📑","category":"research","agent":"builder",
             "description":"Generate formatted citations from a list of sources",
             "inputs":[{"id":"sources","label":"Paste source titles, URLs, or descriptions","type":"textarea","required":True},{"id":"style","label":"Citation style","type":"select","required":False,"options":["APA 7th","MLA 9th","Chicago","Harvard","IEEE"]}],
...
def list_registry():
    ...
    return [
        {**p, "installed": p["id"] in installed, "skills": None,
...
def export_workspace():
    ...
    try:
        ...
        return {
            ...
            "skills":    skills,
            "plugins":   installed,
            "memories":  [{"source": m["source"], "content": m["content"][:500], "tags": m["tags"]}
                          for m in memories],
        }
    except Exception as e:
