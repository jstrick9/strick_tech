...
**Progress: 9 of 12 gaps closed** (all Critical and all High), 2 partial.
...
| **G12** | **No template/method library.** "Method and instance live apart" — we have no blank, reusable, shareable workspace templates. | Medium | 🚧 **IN PROGRESS** | claimed |
