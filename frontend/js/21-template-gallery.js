...
(function() {
  ...
  async function renderTemplates() {
    ...
    try {
      ...
      g.innerHTML = stateFeedback.errorElement({ title: 'Couldn’t load your templates', message: humanError(ex, {action:'load your templates', dataSafe:true}), retry: 'renderTemplates()' });
    }
  }
