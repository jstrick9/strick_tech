...
// ══════════════════════════════════════════════════════════════════
//  ONBOARDING WIZARD — removed (r54)
// ══════════════════════════════════════════════════════════════════
// This section was a SECOND, dead copy of the first-run wizard: its own
// ONBOARDING_STEPS array, showOnboarding/renderOnboardingStep/obBack/
// obNext, and the selectRole/selectMode/selectTemplate helpers.
// 24-onboarding.js is the live wizard — it loads after this file, so its
// global declarations of showOnboarding/obBack/obNext overwrote these,
// and nothing anywhere called the rest (verified: zero references
// outside this file, in markup or any module).
//
// The dead copy still mattered: its 'mode' step PATCHed ui_mode and its
// 'done' step called applyUIMode — code that LOOKED like the wizard's
// mode wiring but never ran. The live wizard has no mode step at all;
// first-run mode is the profile default (simple), applied at boot by
// loadUIConfig -> applyUIMode -> switchUIMode. The wizard itself is
// still triggered from loadUIConfig (!d.onboarding_done ->
// setTimeout(showOnboarding, 800)) and renders into the static
// #onboarding-modal markup in index.html.
// ══════════════════════════════════════════════════════════════════
